<?php
/* Smarty version 4.3.0, created on 2023-06-27 11:05:51
  from 'E:\XAMPP\htdocs\projekt\app\views\components\threadMessagesList.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_649aa66fc3c266_79660218',
...
function content_649aa66fc3c266_79660218 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    <div class="row mb-4">
        <div class="<?php if (\core\SessionUtils::load("username",true) == $_smarty_tpl->tpl_vars['threadMessage']->value["username"]) {?>col-10  offset-2 <?php } else { ?>col-10 <?php }?>">
            <div class="px-0 py-0 row shadow-lg rounded-end p-3 d-flex text-break border  <?php if (\core\SessionUtils::load("username",true) == $_smarty_tpl->tpl_vars['threadMessage']->value["username"]) {?>border-activeUser<?php }?>
                ...
                <div id="top" class=" <?php if (\core\SessionUtils::load("username",true) == $_smarty_tpl->tpl_vars['threadMessage']->value["username"]) {?>bg-activeUser<?php } else { ?>bg-light-subtle<?php }?>  col-12 col-lg-2 text-center d-lg-block d-flex align-items-center">
