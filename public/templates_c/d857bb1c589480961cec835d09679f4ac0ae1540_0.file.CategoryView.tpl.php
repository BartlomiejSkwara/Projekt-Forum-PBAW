...
/resources/icons/filter.svg" alt="" width="16" height="16"> 
    ...
    <a class="btn btn-primary border-primary-subtle  rounded-pill" type="button" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('action'=>'addThreadView'),$_smarty_tpl ) );?>
/<?php echo $_smarty_tpl->tpl_vars['categoryData']->value["idCategory"];?>
">
        <img class=" mx-auto " " src="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array(),$_smarty_tpl ) );?>
